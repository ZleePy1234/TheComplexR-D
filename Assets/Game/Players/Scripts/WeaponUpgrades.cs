...
/// - No hay opci�n de ciclar armas
/// - Cuando compras un arma, se equipa autom�ticamente
...
public class WeaponUpgrades : MonoBehaviour
{
    ...
    /// <summary>
    /// Equipa un arma por �ndice (usado internamente)
    /// </summary>
    ...
    /// <summary>
    /// Equipa un arma por �ndice (p�blico, para la tienda)
    /// </summary>
    public void EquiparArma(int indice)
    {
        if (indice < 0 || indice >= weaponDataList.Count)
        {
            Debug.LogWarning($"�ndice de arma inv�lido: {indice}");
            return;
        }
    ...
    /// <summary>
    /// Obtiene el �ndice del arma actualmente equipada
    /// </summary>
    ...
    /// <summary>
    /// Verifica si un arma espec�fica est� equipada
    /// </summary>
    ...
    #region M�todos de Armas Espec�ficas
    ...
    {
        Debug.Log($"Arma actual: {ObtenerNombreArmaActual()} (�ndice: {indiceArmaActual})");
    }
